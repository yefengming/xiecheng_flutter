...
//          ),
  ...
  Widget _item(BuildContext context, CommonModel model, bool big, bool left, bool last) {
    BorderSide boderSide = BorderSide(width: 0.8, color: Color(0xfff2f2f2));
    ...
    return GestureDetector(
      onTap: (){
        ...
        child: Container(
          decoration: BoxDecoration(
              border: Border(right: left? boderSide : BorderSide.none,
          ...
          child: Image.network(
            model.icon,
            fit: BoxFit.fill,
            width: MediaQuery.of(context).size.width/2-10, //屏幕宽一半
            height: big?129:80,
          ),
        )
    );
